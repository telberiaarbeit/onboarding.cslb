...
<main class="site-main wrap-login user-page" id="create-user">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name Mitarbeiter" value="">
