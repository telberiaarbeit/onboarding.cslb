...
<form action="{{ route('create.checklist') }}" method="post" id="new-form">
    {{ csrf_field() }}
                                        ...
                                        <div class="input-group align-items-end">';
                                            if( isset($tab_entry->$id) && !empty($tab_entry->$id) ) {
                                                ...
                                                <div class="custom-control custom-checkbox mr-sm-2 form-check">
                                                    <input type="checkbox" name="date_category_detail['.$type_group->tab_id.'][exit_date][checkbox]"
                                                ...
                                                <input type="text" class="form-control datetimepicker-input" name="date_category_detail['.$type_group->tab_id.'][exit_date][datetime]"
                                                value="'.$tab_entry->$id.'" style="padding-right: 15px; text-align: left; padding-left: 15px;">';
                                            } else {                                                        
                                                echo'
                                                <div class="custom-control custom-checkbox mr-sm-2 form-check">
                                                    <input type="checkbox" name="date_category_detail['.$type_group->tab_id.'][entry_date][checkbox]"
                                                ...
                                                <input type="text" class="form-control datetimepicker-input" name="date_category_detail['.$type_group->tab_id.'][entry_date][datetime]"
                                ...
                                if(isset($exit_date->$tab_form_id)) {
                                    ...
                                    echo '<div class="group-item col-md-6 mb-5">
                                        ...
                                        if( isset($exit_entry->$id) && !empty($exit_entry->$id) ) {
                                            ...
                                            name="date_category_detail['.$type_group->tab_id.'][exit_date][datetime]" value="'.$exit_entry->$id.'" style="padding-right: 15px; text-align: left; padding-left: 15px;">';
                                        } else {
                                            echo '
                                            <div class="custom-control custom-checkbox mr-sm-2 form-check">
                                                <input type="checkbox" name="date_category_detail['.$type_group->tab_id.'][entry_date][checkbox]"
                                            ...
                                            <input type="text" class="form-control datetimepicker-input" 
                                            name="date_category_detail['.$type_group->tab_id.'][entry_date][datetime]" value="" style="padding-right: 15px; text-align: left; padding-left: 15px;">';
                                        }
                                        echo '    
                                        </div>
                                    </div>';
                                                ...
                                                <div class="group-item">';
                                                    if(!empty($group_deadline->$cat_id)) {
                                                        ...
                                                        '<input type="text" class="form-control datetimepicker-input datetimepicker" 
                                                            ...
                                                            placeholder="Please select a deadline" name="deadline_'.$cat_id.'" value="'.$group_deadline->$cat_id.'">';
                                                    } else {
                                                        echo 
                                                        '<input type="text" 
                                                            ...
                                                            data-target="#datetimepicker-deadline" aria-label="Deadline" 
                                                            style="padding-left: 15px;pointer-events: auto;" 
                                                            placeholder="Please select a deadline" name="deadline_'.$cat_id.'" value="">';
                                                    }
                                                echo'
                                                </div>
                                            </div>';
                                        ...
                                        foreach(DB::table('list_task')->where("category_id",$cat_id)->get() as $task) {
                                            echo ' <div class="row group-item">  
                                                <div class="col-md-4 mb-3 wrap-datetimepicker">
                                                    <input type="text" class="form-control datetimepicker-input" name="'.$cat_id.'_'.$task->id.'" value="">
                                                ...
                                                <div class="col-md-8 mb-3 d-flex align-items-end">
                                                    ...
                                                    data-id="'.$task->id.'">
                                                        <div class="custom-control custom-checkbox form-check">
                                                            ...
                                                            type="checkbox" value="" id="'.$cat_id.'_'.$task->id.'" name="check_task">
                                                        ...
                                                        <input type="hidden" name="listgroup_'.$task->id.'" id="'.$task->id.'_group" class="current_group" value="">
                                                        <input type="hidden" name="listuser_'.$task->id.'" id="'.$task->id.'_user" class="current_user">
                                                    </div>
                                                </div>
                                            </div>';
                                        }
