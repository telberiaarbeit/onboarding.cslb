            ...
            <div class="row">
                <div class="col-lg-12">                   
                    <div class="text-right mb-4">
                        <a class="btn btn-success mb-1" href="{{ url('/users/create') }}">Neuen Benutzer Anlegen</a>
                        <button class="btn btn-success create-new-group mb-1">Neue Gruppe hinzufügen</button>
                        <a class="btn btn-success mb-1" href="{{ url('/group-user') }}">Alle Gruppen</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-12 label-checklist text-uppercase pb-2 mb-2">
                    <div class="row">
                        <div class="checklist-id col-md-1"><strong>Id</strong></div> 
                        <div class="checklist-name col-md-3"><strong>Name Mitarbeiter</strong></div> 
                        <div class="checklist-email col-md-3"><strong>Email</strong></div>
                        <div class="checklist-group col-md-2"><strong>User group</strong></div>
                        <div class="text-right col-md-3"><strong>Action</strong></div>                 
                    </div>
                </div>
