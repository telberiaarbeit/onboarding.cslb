        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-md-12 label-checklist text-uppercase pb-2 mb-2">
                    <div class="row">
                        <div class="checklist-id col-lg-2" data-label="ID"><strong>ID</strong></div> 
                    ...
                    @foreach( $data as $item )
                        <div class="col-md-12 list-checklist">
                            <div class="row mb-4 py-4 item align-items-center">
                                ...
                                <div class="checklist-id col-lg-2" data-label="ID">#{{ $item['id'] }}</div> 
                                <div class="checklist-name col-lg-4" data-label="Name Mitarbeiter">{{ $item['name_vorgesetzter'] }}</div>
