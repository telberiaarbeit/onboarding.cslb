                                            ...
                                            <div class="group-item col-md-6 mb-5">
                                                <div class="input-group align-items-end">
                                                    <div class="custom-control custom-checkbox mr-sm-2 form-check">
                                                        ...
                                                        <label class="custom-control-label" for="entry_date_maternity-leave">Eintritt Datum</label>
                                                    </div>
                                            ...
                                            <div class="group-item col-md-6 mb-5">
                                                <div class="input-group align-items-end">
                                                    <div class="custom-control custom-checkbox mr-sm-2 form-check">
                                                        ...
                                                        <label class="custom-control-label" for="exit_date_maternity-leave">Austritt Datum</label>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 d-flex align-items-start justify-content-between">
                                                        ...
                                                        <div class="group-item">
                                                            ...
                                                            placeholder="Please select a deadline" name="category_sub_detail[{{ $category->id }}_{{ $tab_form->tab_id }}]" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach( $list_task[$category->id] as $task)   
                                                        <div class="row group-item">  
                                                            <div class="col-md-4 mb-3 wrap-datetimepicker">
                                                                ...
                                                                <input type="text" name="task_detail[{{ $task['id'] }}_{{ $tab_form->tab_id }}][abbreviation]" value="{{ $abbreviations }}" class="form-control input-abbreviation">
                                                            </div>
                                                            <div class="col-md-8 mb-3 d-flex align-items-end">
                                                                ...
                                                                data-id="{{ $task['id'] }}">
                                                                    ...
                                                                    <input type="hidden" name="task_detail[{{ $task['id'] }}_{{ $tab_form->tab_id }}][ids]" id="{{ $task['id'] }}_user" class="current_user" value="">
