...
@else
    ...
    <main class="dashboard">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <a href="https://onboarding.cslb.at/new-task" class="button-main">Neue Aufgabe anlegen</a>
                </div>
                            ...
                            foreach($task_data as $task_data) {
                                echo '<div class="row mb-4 py-4 item align-items-center">';
                                    ...
                                    echo '<div class="col-md-2">
                                        <a href="https://onboarding.cslb.at/detail?id='.$task_data['task_id'].'" class="button-main">Mehr lesen</a>
                                    </div> ';
                                echo '</div>';
